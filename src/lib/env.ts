...
const serverEnvSchema = z.object({
  ...
  GEIDEA_MERCHANT_PUBLIC_KEY: optionalNonEmptyString,
  GEIDEA_API_PASSWORD: optionalNonEmptyString,
  GEIDEA_CALLBACK_SECRET: optionalNonEmptyString,
...
export const env = serverEnvSchema.parse({
  ...
  GEIDEA_CALLBACK_SECRET: process.env.GEIDEA_CALLBACK_SECRET,
