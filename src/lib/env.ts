...
const serverEnvSchema = z.object({
  ...
  STREAM_WEBHOOK_SECRET: optionalNonEmptyString,
  ...
  STREAM_PRODUCT_LOCAL_BUSINESS_YEARLY: optionalNonEmptyString,
  STREAM_PRODUCT_MULTI_LOCATION_YEARLY: optionalNonEmptyString,
  STREAM_PRODUCT_AGENCY_MAX_YEARLY: optionalNonEmptyString,
...
export const env = serverEnvSchema.parse({
  ...
  STREAM_PRODUCT_LOCAL_BUSINESS_YEARLY: process.env.STREAM_PRODUCT_LOCAL_BUSINESS_YEARLY,
  STREAM_PRODUCT_MULTI_LOCATION_YEARLY: process.env.STREAM_PRODUCT_MULTI_LOCATION_YEARLY,
  STREAM_PRODUCT_AGENCY_MAX_YEARLY: process.env.STREAM_PRODUCT_AGENCY_MAX_YEARLY,
